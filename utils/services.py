...
def generate_commit_message(diff_msg: str, style: str = "default") -> str | None:
    ...
    Ensure the message is professional and adheres to conventional commit standards. Use the following style: {style}. Make sure that the commit message can be understood irrespective of the style passed.
